...
Simulate a clinical trial from this model, with 2000 particpants in each treatment arm.  Assume that the age distribution for those volunteering for the trial has a mean of 70 and a standard deviation of 8.
