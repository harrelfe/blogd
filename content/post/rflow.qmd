...
```{r summaryrc}
#| label: fig-summaryrc
#| fig-cap: "`summaryRc` function graphics containing a matrix of graphs of nonparametrically estimated relationships between continuous baseline variables and the probability that a patient in the ICU will die in the hospital"
addCap()
par(mfrow=c(2,2))
