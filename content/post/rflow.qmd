...
::: {.column-margin}
[Comments](https://hbiostat.org/comment.html)<br>[Change log](https://github.com/harrelfe/blogd/commits/master/content/post/rflow.qmd)
...
## Confidence Bands for Differences
...
survplotp(f, fun=function(y) 1. - y, height=450, width=700)
```
...
The adverse event chart presented earlier is another example using half-width confidence intervals.
