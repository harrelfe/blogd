...
```{r wbc,results='asis'}
u <- movStats(hospdead ~ wblc, k=6, eps=20,
...
makecolmarg(anova(f), printargs=list(dec.ms=2, dec.ss=2, fontsize=1.2))
...
f
makecnote(anova(f), printargs=list(fontsize=2))   # in collapsible note
# Compensating font size for a problem where the size was too small
