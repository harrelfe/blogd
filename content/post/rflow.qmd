...
To facilitate some operations requiring variable names to be quoted, define a function `.q` to quote them automatically. [`.q` is like the `Hmisc` function `Cs` but also allows elements to be named.]{.aside}
