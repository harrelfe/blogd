...
<tr>
<td style='min-width: 7em; text-align: left;'>tx=SK</td>
...
<tr>
<td style='min-width: 9em; border-left: 1px solid black; border-right: 1px solid black; text-align: center;'>max |∂log <i>L</i>/∂β| 3×10<sup>-10</sup></td>
<td style='min-width: 9em; border-right: 1px solid black; text-align: center;'></td>
...
```r
histSpike(psk - ptpa, bins=seq(-0.02, 0.1, by=0.001), xlim=c(-0.02, 0.1),
