...
[[![](https://hbiostat.org/img/discourse.png)](https://discourse.datamethods.org/t/rms-ordinal-logistic-regression)<br><a href="https://hbiostat.org/comment.html"
  target="popup"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-112021636-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-112021636-1');
</script>
<!--/html_preserve-->
<!-- See https://stackoverflow.com/questions/41376989
