...
## Commenting
To comment, highlight text, or write a question about this article, either go [here](https://discourse.datamethods.org/t/guidelines-for-covariate-adjustment-in-rcts) or do the following:

* Get a free account on [hypothesis](https://hypothes.is)
* Optionally install the `hypothesis` add-on on your browser
* Highlight the relevant text and select "highlight" or "annotate"
* Your highlights/annotations will remain in place even if the document is updated
:::
